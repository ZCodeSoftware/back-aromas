...
import { ICartProduct } from "../../../domain/types/cart.type";

/**
 * Slim adapter for the product aggregate: reads only the fields the cart needs.
 */
@Injectable()
export class ProductRepository implements IProductRepository {
    ...
    async findById(id: string): Promise<ICartProduct | null> {
